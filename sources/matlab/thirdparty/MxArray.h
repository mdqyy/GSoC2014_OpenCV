...
class MxArray
{
  public:
     ...
     */
    inline mwSize numel() const { return (mwSize) mxGetNumberOfElements(p_); }
    /** Number of dimensions.
     */
    inline mwSize ndims() const { return (mwSize) mxGetNumberOfDimensions(p_); }
    /** Array of each dimension.
     */
    inline const mwSize* dims() const { return mxGetDimensions(p_); };
    /** Number of rows in an array.
     */
    inline mwSize rows() const { return (mwSize) mxGetM(p_); }
    /** Number of columns in an array.
     */
    inline mwSize cols() const { return (mwSize) mxGetN(p_); }
